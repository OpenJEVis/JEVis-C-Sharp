...
namespace JEAPI_WS
{
    public class JEVisAttributeWS : JEVisAttribute
    {

    public static  DateTimeFormatter attDTF = ISODateTimeFormat.dateTime();
    private static  Logger logger = LogManager.getLogger(JEVisAttributeWS.class);
    ...
    public JEVisAttributeType getType()
    {
    ...
    public List<JEVisSample> getSamples(DateTime from, DateTime to, bool customWorkDay, String aggregationPeriod, String manipulationPeriod)
    {
...
return imported;
    ...
    public JEVisSample buildSample(DateTime ts, Object value)
{
...
return newSample;
    ...
    public JEVisSample buildSample(DateTime ts, double value, String note, JEVisUnit unit)
{
    JsonSample newJson = new JsonSample();
newJson.setTs(attDTF.print(ts));
    ...
    public DateTime getTimestampFromLastSample()
{
    ...
    public bool deleteAllSample()
{
    bool delete = deleteSamplesBetween(null, null);
    ds.reloadAttribute(this);
    return delete;
}


    public bool deleteSamplesBetween(DateTime from, DateTime to)
{
    try
    {
    ...
    public void setInputSampleRate(Period period)
{
    ...
    public bool isType(JEVisAttributeType type
    )
{
    try
    {
